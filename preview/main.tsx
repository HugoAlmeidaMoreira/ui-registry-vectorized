        ...
        <section className="rounded-2xl border border-border bg-card p-6 shadow-sm sm:p-8">
          <div>
            ...
            <p className="mt-1 max-w-2xl text-sm text-muted-foreground">
              <code>bare</code> keeps the body and the thumb but drops the outer rim and the outer
              shell. Both appearances are 20 shorter than the original drawing. The bare window is
              112x66 around the same centre, and its body fills it.
            </p>
          </div>
              ...
              <div key={appearance} className="rounded-xl border border-border p-4">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <span className="text-xs text-muted-foreground">
                    {appearance === "reference" ? "window 140\u00d780" : "window 112\u00d766"}
                  </span>
                </div>
